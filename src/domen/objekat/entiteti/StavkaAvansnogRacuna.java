 ...
 * @author Veljko
 */
public class StavkaAvansnogRacuna extends DomenskiObjekat{

    private AvansniRacun AvansniRacun;
    ...
    public boolean equals(Object obj) {
        ...
        final StavkaAvansnogRacuna other = (StavkaAvansnogRacuna) obj;
        ...
        if (!Objects.equals(this.AvansniRacun, other.AvansniRacun)) {
            return false;
        }
    ...
    public AvansniRacun getAvansniRacun() {
        return AvansniRacun;
    }

    public void setAvansniRacun(AvansniRacun AvansniRacun) {
        this.AvansniRacun = AvansniRacun;
    }
